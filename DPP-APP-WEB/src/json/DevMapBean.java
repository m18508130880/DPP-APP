		...
		switch (pCmd)
		{
			case 0:// admin查询（类型&项目）
				Sql = " select t.id,t.project_id, t.project_name, t.type, t.cname, t.lngandlat, t.des" +
					  " from view_dev_map t where t.project_id = '" + currStatus.getFunc_Project_Id() + "'" + " order by t.id  ";
				break;
			case 10:// 添加
				Sql = " insert into dev_map(id, project_Id, type, CName, LngAndLat, des) " + 
					  " values('" + Id + "','" + Project_Id + "','" + Type + "','"+ CName + "','"+ LngAndLat + "','"+ Des + "')";
				break;
			case 11:// 编辑
				Sql = " update dev_map t set t.project_Id = '" + currStatus.getFunc_Project_Id() + "', type = '" + Type + "', CName = '" + CName + "', LngAndLat = '"+LngAndLat+"', des = '" + Des + "' where t.id = '" + Id + "' and t.project_id = '" + currStatus.getFunc_Project_Id() + "'";
				break;
			case 12:// 删除
				Sql = " delete from dev_map where id = '" + Id + "' and project_id = '" + currStatus.getFunc_Project_Id() + "'";
				break;
