...
public class MainServlet extends HttpServlet
{
        ...
        HttpServletResponse response) throws ServletException, IOException
    {
        ...
        /*****************************************首页************************************************/
        if (strUrl.equalsIgnoreCase("getNewsList.do"))				        			//新闻列表
        	new AppNewsBean().ExecCmd(request, response, m_Rmi, false, strUrl, TokenList);
        if (strUrl.equalsIgnoreCase("getUseList.do"))				        			//案例列表
        	new AppUseBean().ExecCmd(request, response, m_Rmi, false, strUrl, TokenList);
